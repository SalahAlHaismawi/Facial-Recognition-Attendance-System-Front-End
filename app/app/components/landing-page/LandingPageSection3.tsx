        ...
        <div className='min-h-screen w-[90%] flex flex-row justify-between'>
            <div className='my-auto'>
                ...
                <h1 className='text-5xl font-bold text-white W-[30%] flex flex-col mt-5'>
                    <span className="truncate overflow-hidden whitespace-nowrap text">MANAGE RECORDS</span>
                    <span className="truncate overflow-hidden whitespace-nowrap underline">ON THE GO.</span>
